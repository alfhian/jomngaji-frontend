...
class LatihanGhunnahPilihanPage extends StatefulWidget {
  const LatihanGhunnahPilihanPage({super.key});

  @override
  State<LatihanGhunnahPilihanPage> createState() =>
      _LatihanGhunnahPilihanPageState();
}

class _LatihanGhunnahPilihanPageState extends State<LatihanGhunnahPilihanPage> {
  final List<Map<String, dynamic>> soalList = [
    {
      ...
      "jawaban": "Ghunnah (Nun Tasydid)",
      "opsi": ["Ghunnah (Nun Tasydid)", "Ghunnah (Mim Tasydid)", "Tidak Ghunnah"]
    },
    {
      "ayat": [
    ...
    },
    {
      ...
      "jawaban": "Ghunnah (Ikhfa Nun)",
      "opsi": ["Ghunnah (Ikhfa Nun)", "Ghunnah (Idgham)", "Tidak Ghunnah"]
    },
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomGradientAppBar(title: "Latihan Ghunnah (Pilihan Ganda)"),
      body: Column(
        children: [
          Expanded(
            child: Padding(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            "Latihan ini membantu kamu mengenali hukum Ghunnah: Nun/Mim tasydid, Ikhfa, dan Idgham dengan dengungan. "
            "Setiap sesi berisi beberapa soal pilihan ganda dengan highlight huruf Ghunnah agar fokus belajar lebih jelas.",
            textAlign: TextAlign.center,
