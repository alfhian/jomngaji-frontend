...
class LatihanMadMenuPage extends StatelessWidget {
  const LatihanMadMenuPage({super.key});
  ...
  Widget _descriptionSection() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            "Pilih gaya latihan untuk menguasai hukum Mad (Thabi'i, Wajib Muttashil, Jaiz Munfashil, ‘Aridh Lis-Sukun, Lin, Lazim).",
  ...
  Future<double> _loadProgress() async {
    try {
      final combined = await TajwidQuizService.getCombinedProgress('mad');
      ...
      child: Column(
        children: [
          _exerciseItem(
            ...
            subtitle: "Jawab soal pilihan untuk mengenali hukum Mad",
            icon: Icons.quiz_rounded,
            color: const Color(0xFFE3F2FD),
            iconColor: const Color(0xFF2196F3),
            onTap: () => Navigator.pushNamed(context, AppRoutes.latihanMadPilihan),
            scoreBadge: const TajwidBestScoreBadge(quizCode: 'mad', label: 'Best score soal'),
            unlocked: true,
          ),
          _exerciseItem(
            context,
            ...
            onTap: () => Navigator.pushNamed(context, AppRoutes.latihanMadRecording),
            scoreBadge: const TajwidBestScoreBadge(quizCode: 'mad', label: 'Best score praktek', source: TajwidBestScoreSource.recording),
            unlocked: true,
          ),
        ],
      ),
