...
class LatihanGhunnahMenuPage extends StatelessWidget {
  const LatihanGhunnahMenuPage({super.key});
  ...
  Widget _descriptionSection() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            "Pilih gaya latihan untuk menguasai hukum Ghunnah (Nun/Mim tasydid, Ikhfa, Idgham dengan dengungan).",
      ...
      child: Column(
        children: [
          _exerciseItem(
            ...
            subtitle: "Jawab soal pilihan untuk mengenali hukum Ghunnah",
            icon: Icons.quiz_rounded,
            color: const Color(0xFFE3F2FD),
            iconColor: const Color(0xFF2196F3),
            onTap: () => Navigator.pushNamed(context, AppRoutes.latihanGhunnahPilihan),
            scoreBadge: const TajwidBestScoreBadge(quizCode: 'ghunnah', label: 'Best score soal'),
            unlocked: true,
          ),
          _exerciseItem(
            context,
