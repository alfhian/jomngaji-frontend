...
class LatihanMimMatiPilihanPage extends StatefulWidget {
  const LatihanMimMatiPilihanPage({super.key});

  @override
  State<LatihanMimMatiPilihanPage> createState() =>
      _LatihanMimMatiPilihanPageState();
}

class _LatihanMimMatiPilihanPageState extends State<LatihanMimMatiPilihanPage> {
  final List<Map<String, dynamic>> soalList = [
    {
      "ayat": [
        const TextSpan(text: "تَرْمِيهِ"),
        const TextSpan(
          text: "مْ",
          style: TextStyle(color: Colors.green, fontWeight: FontWeight.bold),
        ),
        const TextSpan(text: " بِحِجَارَةٍ"),
      ],
      "jawaban": "Ikhfa Syafawi",
      "opsi": ["Idzhar Syafawi", "Ikhfa Syafawi", "Idgham Mimi"]
    },
    {
      "ayat": [
        const TextSpan(text: "عَلَيْهِ"),
        const TextSpan(
          text: "مْ",
          style: TextStyle(color: Colors.green, fontWeight: FontWeight.bold),
        ),
        const TextSpan(text: " قِتَالًا"),
      ],
    ...
    {
      "ayat": [
        const TextSpan(text: "كَ"),
        const TextSpan(
          text: "مْ",
          style: TextStyle(color: Colors.green, fontWeight: FontWeight.bold),
        ),
        const TextSpan(text: " مَثَلُهُمْ"),
      ],
      "jawaban": "Idgham Mimi",
      "opsi": ["Idzhar Syafawi", "Ikhfa Syafawi", "Idgham Mimi"]
    },
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomGradientAppBar(title: "Latihan Mim Mati"),
      body: Column(
        children: [
          Expanded(
            child: Padding(
                    ...
                    child: Center(
                      child: RichText(
                        ...
                        text: TextSpan(
                          ...
                          children: soal["ayat"] as List<TextSpan>, // ✅ cast ke List<TextSpan>
                        ),
                      ),
                    ),
                  ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            "Latihan ini membantu kamu mengenali hukum Mim Mati (Idzhar Syafawi, Ikhfa Syafawi, Idgham Mimi). "
