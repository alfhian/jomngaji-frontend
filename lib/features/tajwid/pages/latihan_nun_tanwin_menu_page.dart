  ...
  Widget _descriptionSection() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            "Pilih gaya latihan untuk menguasai hukum Nun Mati & Tanwin (Idzhar, Ikhfa, Idgham, Iqlab).",
      ...
      child: Column(
        children: [
          _exerciseItem(
            ...
            subtitle: "Jawab soal pilihan untuk mengenali hukum Nun Mati & Tanwin",
