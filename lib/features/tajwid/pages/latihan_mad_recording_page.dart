...
class LatihanMadRecordingPage extends StatefulWidget {
  const LatihanMadRecordingPage({super.key});

  @override
  State<LatihanMadRecordingPage> createState() =>
      _LatihanMadRecordingPageState();
}

class _LatihanMadRecordingPageState extends State<LatihanMadRecordingPage> {
    ...
    if (ayatIndex < ayatList.length - 1) {
      ...
      showDialog(
        ...
        builder: (_) => AlertDialog(
          ...
          content: Text(
            "Kamu sudah mencoba semua contoh hukum Mad.",
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text("Latihan Mad (Recording)")),
      body: Column(
        children: [
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    "Latihan membaca hukum Mad dengan praktek suara.\n"
                    "Tekan tombol mic untuk mulai rekam, lalu putar dan nilai bacaanmu.\n"
                    "Setiap ayat menampilkan hukum Mad yang berbeda.",
                ...
                // Ayat contoh di tengah & besar dengan highlight Mad
                Center(
                  child: RichText(
                    textAlign: TextAlign.center,
                    text: TextSpan(
