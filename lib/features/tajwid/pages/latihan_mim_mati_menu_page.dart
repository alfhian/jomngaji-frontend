...
class LatihanMimMatiMenuPage extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          _progressSection(), // ikut tema yang ada progress bar
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        image: const DecorationImage(
          image: AssetImage("assets/images/hijaiyah_banner_2.png"), // saran: siapkan banner khusus
          fit: BoxFit.cover,
        ),
      ),
      child: Container(
  ...
  Widget _descriptionSection() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            "Pilih gaya latihan untuk menguasai hukum Mim Mati (Idzhar Syafawi, Ikhfa Syafawi, Idgham Mimi).",
  ...
  Future<double> _loadProgress() async {
    try {
      final combined = await TajwidQuizService.getCombinedProgress('mim_mati');
      ...
      child: Column(
        children: [
          _exerciseItem(
            ...
            subtitle: "Jawab soal pilihan untuk mengenali hukum Mim Mati",
