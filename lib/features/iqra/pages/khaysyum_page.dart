...
class KhaysyumPage extends StatefulWidget {
  const KhaysyumPage({super.key});

  @override
  State<KhaysyumPage> createState() => _KhaysyumPageState();
}

class _KhaysyumPageState extends State<KhaysyumPage> {
  final List<Map<String, String>> hurufList = [
    {"huruf": "ن", "nama": "Nun (Ghunnah)"},
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomGradientAppBar(title: "Khaysyum (Rongga Hidung)"),
      body: Column(
        children: [
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                // Tombol Next/Lanjut (meski hanya 1 huruf, tetap ada tombol Selesai)
                ElevatedButton(
                  style: ElevatedButton.styleFrom(
                    backgroundColor: const Color(0xFF42C88A),
                    shape: RoundedRectangleBorder(
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            "Khaysyum adalah huruf yang keluar dari rongga hidung (ghunnah). "
