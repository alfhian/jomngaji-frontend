...
class SyafawiPage extends StatefulWidget {
  const SyafawiPage({super.key});

  @override
  State<SyafawiPage> createState() => _SyafawiPageState();
}

class _SyafawiPageState extends State<SyafawiPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomGradientAppBar(title: "Syafawi (Bibir)"),
      body: Column(
        children: [
          Expanded(
            child: ListView(
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            "Syafawi adalah huruf yang keluar dari bibir. "
