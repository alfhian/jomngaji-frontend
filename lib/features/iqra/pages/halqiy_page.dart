...
class HalqiyPage extends StatefulWidget {
  const HalqiyPage({super.key});

  @override
  State<HalqiyPage> createState() => _HalqiyPageState();
}

class _HalqiyPageState extends State<HalqiyPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomGradientAppBar(title: "Halqiy (Tenggorokan)"),
      body: Column(
        children: [
          Expanded(
            child: ListView(
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            "Halqiy adalah huruf yang keluar dari tenggorokan. "
